...
export const products: Product[] = [
  ...
  {
    id: "decorative-ceramic-vase",
    name: "Decorative Ceramic Vase",
    category: "Home Decor",
    price: 54,
    image: "https://images.sharetextures.com/u/acd64e05-ae60-4851-9908-5882f44b8d62.webp",
    shortDescription: "A sculptural accent vase for shelves, dining tables, and entryway consoles.",
    description:
      "Add a polished finishing touch to your home with a decorative ceramic vase that works beautifully on its own or styled with dried stems.",
    badge: "New",
    rating: 4.7,
    reviews: 486,
    availability: "In stock",
    colors: ["Charcoal", "Stone"],
    highlights: ["Sculptural silhouette", "Matte ceramic finish", "Ideal for shelves and tabletops"],
    features: [
      "Decorative ceramic body with a modern organic shape",
      "Works as a standalone accent or with dried botanicals",
      "Sized for mantels, bookshelves, consoles, and dining tables",
    ],
    specs: [
